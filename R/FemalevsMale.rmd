...
SleuthTopIsoformSig <- (filter(SleuthTopIsoform, qval<.1 & ! is.na(Id)))
...
gene_vs_isoform_Sleuth <- SleuthSig %>%
  dplyr::select(Id, SYMBOL, Chr, gene_type) %>%
...
```{r enrichment}
fittedBias_tr <- read_tsv("../Shiny/GENEX-FB1/Data/fitted_tr.txt")
fittedBias <- read_tsv("../Shiny/GENEX-FB1/Data/fitted.txt")
