...
- Samples with < 10 million read pairs in count matrix:
    - 17046 has 78% of reads mapping to rDNA
    - 18655 has relatively low sequencing depth (78 million read pairs) once I exluded the first batch of sequence because I don't know how to combine technical replicates with different batch effects. It also has a lot of ribosomal
    
- one additional samples with <10% of read pairs in count matrix has ~50% of reads mapping to rDNA (16428)

- 11971 has 671 million read pairs and >450 million in count matrix
