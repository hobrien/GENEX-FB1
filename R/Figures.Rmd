...
- ENSG00000228906 (RP13-216E22.4) is in Xinactivation.txt
- AL672277.1/ENSG00000237531, is expressed at a low level in both sexes, but a higher level in females. I've confirmed that it is in PAR1
...
XCI_DE <- dplyr::filter(fittedBias, Chr=='chrX') %>% 
  ...
  filter(SYMBOL != 'XIST')
filter(XCI_DE, Status == 'Unknown' & sig >0) %>% write_tsv("../Paper/NovelXCIescape.txt")
