...
folders <- list.dirs("/c8000xd3/rnaseq-heath/Mappings", recursive=FALSE)
LibraryInfo <- read.delim("~/GENEX-FB1/Data/SampleInfo.txt", 
...
for (folder in folders) {
  ...
  temp$sample <- sample
  temp$centre <- LibraryInfo[LibraryInfo$Sample == sample,5]
